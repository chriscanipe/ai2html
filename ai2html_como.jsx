...
var fonts = [
  ...
  { "aifont": "SourceSansPro-Regular", "family": "Source Sans Pro,helvetica,sans-serif", "weight": "400", "style": "" },
  { "aifont": "SourceSansPro-Semibold", "family": "Source Sans Pro,helvetica,sans-serif", "weight": "600", "style": "" }
        ...
        for (var k=0;k<thisFrame.paragraphs.length;k++) {
          ...
          if (runningChars<numChars && thisFrame.paragraphs[k].characters.length!=0) {
            ...
            if (thisFrame.paragraphs[k].characters[sampleChar].fillColor.typename=="GrayColor") {
              ...
              // alert(thisFrame.paragraphs[k].characters[sampleChar].fillColor.typename);
